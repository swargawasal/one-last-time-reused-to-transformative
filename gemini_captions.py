...
class GeminiCaptionGenerator:
    ...
    def __init__(self):
        ...
        logger.info("✅ Gemini Caption Generator initialized")
    ...
    def generate_caption(self, image_path: str, style: str = "viral") -> str:
        ...
        Args:
            ...
            style: Caption style (viral, descriptive, question, emoji, clickbait)
        ...
        prompts = {
            "viral": (
                "Generate a SHORT, VIRAL, attention-grabbing caption (maximum 5 words) for this video frame. "
                "Make it exciting, clickable, and perfect for social media. "
                "Use ALL CAPS if appropriate. Be creative and engaging!"
            ),
            "descriptive": (
        ...
        try:
            ...
            # Check for full prompt override from .env
            full_prompt_override = os.getenv("AI_CAPTION_PROMPT")

            # Check for custom content override from .env
            ...
            logger.info(f"🤖 Generating caption with prompt: {prompt[:50]}...")
            ...
            return fallbacks.get(style, "🔥 VIRAL")
    ...
    def detect_watermark_location(self, image_path: str, target_text: str = None) -> Optional[dict]:
        ...
        if "," in target_text:
            ...
            prompt = (
                ...
                f"ONLY detect the specific text '{target_text}'. "
