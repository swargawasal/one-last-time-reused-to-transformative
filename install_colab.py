...
# ------------------------------------------------------------
# PATCH basicsr degradations import issue
# ------------------------------------------------------------
try:
    import site
    ...
    if os.path.exists(degradations_file):
        ...
        if content != new_content:
            ...
            print("ℹ️ basicsr already patched or version differs")
    else:
        print("⚠️ basicsr not found, skipping patch (may be installed later)")
...
print("\nUse Colab Secrets or upload .env manually.")
